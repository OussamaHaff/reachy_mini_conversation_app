...
# OpenAI-style voice aliases mapped by the ElevenLabs backend to concrete
...
ELEVENLABS_AGENT_ID_ENV = "ELEVENLABS_AGENT_ID"
ELEVENLABS_API_BASE_URL_ENV = "ELEVENLABS_API_BASE_URL"
...
class Config:
    ...
    ELEVENLABS_AGENT_ID = os.getenv(ELEVENLABS_AGENT_ID_ENV)
    ELEVENLABS_API_BASE_URL = os.getenv(ELEVENLABS_API_BASE_URL_ENV)
...
def refresh_runtime_config_from_env() -> None:
    ...
    config.ELEVENLABS_AGENT_ID = os.getenv(ELEVENLABS_AGENT_ID_ENV)
    config.ELEVENLABS_API_BASE_URL = os.getenv(ELEVENLABS_API_BASE_URL_ENV)
...
def get_available_voices_for_backend(backend: str | None = None) -> list[str]:
    ...
    if normalized_backend == ELEVENLABS_BACKEND:
